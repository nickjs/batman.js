...
Binding keypaths may be passed through view filters. See the [`Batman.View Filters` documentation](/docs/api/batman.view_filters.html) for more information.
...
The node is considered _viewed_ when the binding is initialized.
