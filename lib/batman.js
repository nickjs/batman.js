  ...
  Batman.DOM.events = {
    click: function(node, callback, context, eventName) {
      ...
      Batman.DOM.addEventListener(node, eventName, function() {
        ...
        return Batman.DOM.preventDefault(args[0]);
      });
  ...
  Batman.PluralAssociation = (function(_super) {
    ...
    PluralAssociation.prototype.setForRecord = function(record) {
      ...
      Batman.Property.withoutTracking(function() {
        return _this._recordProxies.getOrSet(record, function() {
          var existingValueSet, newSet;
          if (indexValue != null) {
            existingValueSet = _this._keyValueProxies.get(indexValue);
          ...
          if (indexValue != null) {
            _this._keyValueProxies.set(indexValue, newSet);
          }
          return newSet;
        });
      });
      if (indexValue != null) {
        return this.setIndex().get(indexValue);
      } else {
        return this._recordProxies.get(record);
      }
    };
    ...
    PluralAssociation.prototype.setForKey = Batman.Property.wrapTrackingPrevention(function(indexValue) {
      var foundSet,
        _this = this;
      foundSet = void 0;
      this._recordProxies.forEach(function(record, set) {
        if (foundSet != null) {
          return;
        }
      ...
      return this._keyValueProxies.getOrSet(indexValue, function() {
    ...
    PluralAssociation.prototype.indexValueForRecord = function(record) {
      return record.get(thisprimaryKey);
    };

    PluralAssociation.prototype.reset = function() {
      PluralAssociation.__super__.reset.apply(this, arguments);
      return this._resetProxyHashes();
    };

    PluralAssociation.prototype._resetProxyHashes = function() {
      this._recordProxies = new Batman.SimpleHash;
      return this._keyValueProxies = new Batman.SimpleHash;
    };
      ...
      if (self.getRelatedModel()) {
        ...
        if ((_ref = proxy._loadSetter) == null) {
          proxy._loadSetter = proxy.once('loaded', function(child) {
            return parent.set(self.label, child);
          });
        }
