      ...
      get: function() {
        if (this.resourceName != null) {
          ...
          if (Batman.config.minificationErrors) {
            Batman.developer.error("Please define className on the class or storageKey on the prototype of " + (Batman.functionName(this)) + " in order for your model to be minification safe.");
          }
  ...
  Batman.Controller = (function(_super) {
    ...
    Controller.prototype.render = function(options) {
      ...
      if (frame && frame.actionTaken && this._renderedYields[options.into]) {
        Batman.developer.warn("Warning! Trying to render but an action has already be taken during " + (this.get('routingKey')) + "." + action + " on yield " + options.into);
      }
      if (frame != null) {
        frame.actionTaken = true;
      }
      ...
      if (!options.view) {
        options.viewClass || (options.viewClass = ((_ref2 = Batman.currentApp) != null ? _ref2[Batman.helpers.camelize("" + (this.get('routingKey')) + "_" + action + "_view")] : void 0) || Batman.View);
