(function() {
  ...
  Batman.EventEmitter = {
    ...
    off: function(key, handler) {
      return this.event(key).removeHandler(handler);
    },
    onFirst: function(key, originalHandler) {
      var event, handler;
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.observeFirst = function(originalHandler) {
      var event, handler;
  ...
  Batman.Observable = {
    ...
    observeFirst: function() {
      var args, key, _ref;
      key = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      (_ref = this.property(key)).observeFirst.apply(_ref, args);
      return this;
    }
  };
  ...
  Batman.Model = (function(_super) {
    ...
    _ref1 = ['load', 'save', 'validate', 'destroy', 'fromJSON'];
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
