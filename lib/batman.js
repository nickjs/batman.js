...
(function() {
  ...
  Batman.RestStorage = (function(_super) {
    var extractFromNamespace, key, _fn, _i, _len, _ref,
      _this = this;
    ...
    extractFromNamespace = function(data, namespace) {
    ...
    RestStorage.prototype.after('create', 'read', 'update', RestStorage.skipIfError(function(env, next) {
      var json;
      if (env.json != null) {
        json = extractFromNamespace(env.json, this.recordJsonNamespace(env.subject));
