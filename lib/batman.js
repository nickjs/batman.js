...
(function() {
  ...
  Batman.AssociationValidator = (function(_super) {

    __extends(AssociationValidator, _super);

    function AssociationValidator() {
      return AssociationValidator.__super__.constructor.apply(this, arguments);
    }

    AssociationValidator.triggers('association');

    AssociationValidator.options('allowBlank');

    AssociationValidator.prototype.validateEach = function(errors, record, key, callback) {
      ...
      if (!(value != null)) {
        errors.add(key, this.format(key, 'not_valid'));
      }
