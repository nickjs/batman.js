(function() {
  ...
  Batman.Set = (function(_super) {
    ...
    Set._applySetAccessors = function(klass) {
      var accessor, accessors, key, _i, _len, _results;
      accessors = {
        first: function() {
      ...
      _results = [];
      for (accessor = _i = 0, _len = accessors.length; _i < _len; accessor = ++_i) {
        key = accessors[accessor];
  ...
  Batman.Request = (function(_super) {
    ...
    Request.wrapAccessor('method', function(core) {
      return {
        set: function(k, val) {
          return core.set.call(k, val != null ? typeof val.toUpperCase === "function" ? val.toUpperCase() : void 0 : void 0);
        }
      };
    });
  ...
  Batman.Model = (function(_super) {
    ...
    Model.prototype.save = function(options, callback) {
      ...
      return this.validate(function(isValid, errors) {
        ...
        return _this._doStorageOperation((creating ? 'create' : 'update'), options, function(err, record, env) {
          var _ref5, _ref6;
          if (!err) {
            if (creating) {
              _this.created();
