...
(function() {
  var chr, _encodedChars, _encodedCharsPattern, _entityMap, _entityMapReversed, _implementImmediates, _objectToString, _unsafeChars, _unsafeCharsPattern,
    __slice = [].slice,
  ...
  Batman.unescapeHTML = (function() {
    return function(s) {
      return ("" + s).replace(_encodedCharsPattern, function(c) {
        return _entityMapReversed[c];
      });
    };
  })();
...
(function() {
  ...
  Batman.Event = (function() {
    ...
    Event.prototype.eachHandler = function(iterator) {
      var ancestor, handlers, key, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results;
      this.handlers.slice().forEach(iterator);
      if ((_ref = this.base) != null ? _ref.isEventEmitter : void 0) {
        key = this.key;
        _ref2 = (_ref1 = this.base._batman) != null ? _ref1.ancestors() : void 0;
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          ...
          if (ancestor.isEventEmitter && ((_ref3 = ancestor._batman) != null ? (_ref4 = _ref3.events) != null ? _ref4.hasOwnProperty(key) : void 0 : void 0)) {
            handlers = (_ref5 = ancestor.event(key, false)) != null ? _ref5.handlers : void 0;
            _results.push(handlers != null ? handlers.slice().forEach(iterator) : void 0);
          } else {
    ...
    Event.prototype.fire = function() {
      return this.fireWithContext.apply(this, [this.handlerContext()].concat(__slice.call(arguments)));
    };

    Event.prototype.fireWithContext = function() {
      var args, context;
    ...
    Event.prototype.allowAndFire = function() {
      return this.allowAndFireWithContext.apply(this, [this.handlerContext].concat(__slice.call(arguments)));
    };

    Event.prototype.allowAndFireWithContext = function() {
      var args, context;
      context = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      this.allow();
      return this.fireWithContext.apply(this, [context].concat(__slice.call(arguments)));
    };
  ...
  Batman.EventEmitter = {
    ...
    mutation: function(wrappedFunction) {
      return function() {
        ...
        if ((_ref = this.event('change')) != null) {
          _ref.fire(this, this);
        }
        return result;
      };
    ...
    fire: function() {
      ...
      return (_ref = this.event(key, false)) != null ? _ref.fireWithContext.apply(_ref, [this].concat(__slice.call(args))) : void 0;
    },
    allowAndFire: function() {
      var args, key, _ref;
      key = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      return (_ref = this.event(key, false)) != null ? _ref.allowAndFireWithContext.apply(_ref, [this].concat(__slice.call(args))) : void 0;
    }
  };
...
(function() {
  ...
  Batman.Property = (function() {
    ...
    Property.registerSource = function(obj) {
      ...
      return (_ref = this.sourceTracker()) != null ? _ref.push(obj) : void 0;
    };

    Property.pushSourceTracker = function() {
      return Batman.Property._sourceTrackerStack.push([]);
    };
    ...
    Property.prototype.eachObserver = function(iterator) {
      var ancestor, handlers, key, object, property, _i, _j, _len, _len1, _ref, _ref1, _results;
      key = this.key;
      _ref = this.changeEvent().handlers.slice();
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        object = _ref[_i];
        iterator(object);
      }
