    ...
    HasManyAssociation.prototype.encoder = function() {
      ...
      return {
        ...
        decode: function(data, key, _, __, parentRecord) {
          var existingRecord, existingRelations, jsonObject, record, relatedModel, _i, _len;
          if (relatedModel = association.getRelatedModel()) {
            ...
            for (_i = 0, _len = data.length; _i < _len; _i++) {
              ...
              existingRecord = existingRelations.indexedBy(association.foreignKey).get(record.get('id'));
