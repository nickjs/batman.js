...
(function() {
  ...
  Batman.EventEmitter = {
    ...
    event: function(key, copy) {
      var ancestor, eventClass, events, existingEvent, newEvent, _base, _i, _len, _ref, _ref1, _ref2;
      if (copy == null) {
        copy = true;
      }
      ...
      if (events.hasOwnProperty(key)) {
        ...
        _ref = this._batman.ancestors();
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ancestor = _ref[_i];
          existingEvent = (_ref1 = ancestor._batman) != null ? (_ref2 = _ref1.events) != null ? _ref2[key] : void 0 : void 0;
          if (existingEvent) {
            break;
          }
        }
    ...
    fire: function() {
      ...
      return (_ref = this.event(key, false)) != null ? _ref.fire.apply(_ref, args) : void 0;
    },
    allowAndFire: function() {
      var args, key, _ref;
      key = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      return (_ref = this.event(key, false)) != null ? _ref.allowAndFire.apply(_ref, args) : void 0;
    }
  };
