...
(function() {
  ...
  Batman.EventEmitter = {
    ...
    once: function() {
      var event, handler, key, keys, originalHandler, _i, _j, _len, _results;
      keys = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), originalHandler = arguments[_i++];
      _results = [];
      for (_j = 0, _len = keys.length; _j < _len; _j++) {
        key = keys[_j];
        ...
        _results.push(event.addHandler(handler));
      }
      return _results;
    },
