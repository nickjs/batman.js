(function() {
  ...
  Batman.getPrototypeOf = function(object) {
  ...
  Batman._Batman = _Batman = (function() {
    ...
    _Batman.prototype.ancestors = function(getter) {
      ...
      parent = isClass ? (_ref = this.object.__super__) != null ? _ref.constructor : void 0 : (proto = Batman.getPrototypeOf(this.object)) === this.object ? this.object.constructor.__super__ : proto;
      if (parent != null) {
