(function() {
  ...
  Batman.Model = (function() {
    ...
    Model.LifecycleStateMachine = (function() {
      ...
      __extends(LifecycleStateMachine, Batman.DelegatingStateMachine);
    ...
    Model.classAccessor('lifecycle', function() {
      ...
      return (_base = this._batman).lifecycle || (_base.lifecycle = new Model.LifecycleStateMachine('empty', this));
    });
