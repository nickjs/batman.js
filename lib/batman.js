(function() {
  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.dispatch = function(action, params) {
      var name, redirectTo, yield, _ref;
    ...
    Controller.prototype.executeAction = function(action, params) {
      var frame, oldRedirect, result, _ref, _ref2, _ref3;
      if (params == null) params = this.get('params');
      ...
      if (!frame.actionTaken) this.render();
    ...
    Controller.prototype.render = function(options) {
      var action, frame, view, _ref, _ref2, _ref3, _ref4;
      var _this = this;
      if (options == null) options = {};
      ...
      if (frame != null) frame.actionTaken = true;
      if (options === false) return;
      if ((_ref2 = this._renderedYields) != null) _ref2[options.into] = true;
      if (!options.view) {
        options.viewClass || (options.viewClass = ((_ref3 = Batman.currentApp) != null ? _ref3[helpers.camelize("" + (this.get('controllerName')) + "_" + action + "_view")] : void 0) || Batman.View);
      ...
      if (view) {
        if ((_ref4 = Batman.currentApp) != null) _ref4.prevent('ready');
        view.on('ready', function() {
          var _ref5;
          Batman.DOM.Yield.withName(options.into).replace(view.get('node'));
          return (_ref5 = Batman.currentApp) != null ? _ref5.allowAndFire('ready') : void 0;
        });
      }
      return view;
    };
