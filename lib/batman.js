...
(function() {
  ...
  Batman.DOM.IteratorBinding = (function(_super) {
    ...
    function IteratorBinding(sourceNode, iteratorName, key, context, parentRenderer) {
      ...
      this.startNode = document.createComment("start " + this.iteratorName + "-" + (this.get('objectID')));
      this.endNode = document.createComment("end " + this.iteratorName + "-" + (this.get('objectID')));
