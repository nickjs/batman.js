...
(function() {
  ...
  Batman.Property = (function() {
    ...
    Property._sourceTrackerStack.valid = true;
    ...
    Property.registerSource = function(obj) {
      ...
      if (!Batman.Property._sourceTrackerStack.valid) {
        set = [];
        Batman.Property._sourceTrackerStack.push(set);
        Batman.Property._sourceTrackerStack.valid = true;
      } else {
        set = Batman.Property._sourceTrackerStack[Batman.Property._sourceTrackerStack.length - 1];
      }
      if (set != null) {
        set.push(obj);
      }
    ...
    Property.pushSourceTracker = function() {
      if (!Batman.Property._sourceTrackerStack.valid) {
        ...
        return Batman.Property._sourceTrackerStack.valid = false;
      }
    };
