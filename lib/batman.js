(function() {
  ...
  Batman.Controller = (function(_super) {
    ...
    Controller.prototype.redirect = function(url) {
      ...
      if (frame) {
        if (frame.actionTaken) {
          developer.warn("Warning! Trying to redirect but an action has already be taken during " + (this.get('controllerName')) + "." + (frame.action || this.get('action')) + "}");
        }
    ...
    Controller.prototype.render = function(options) {
      ...
      if (frame && frame.actionTaken && this._renderedYields[options.into]) {
        developer.warn("Warning! Trying to render but an action has already be taken during " + (this.get('controllerName')) + "." + action + " on yield " + options.into);
      }
      if (frame != null) {
        frame.actionTaken = true;
      }
  ...
  Batman.StorageAdapter = (function(_super) {
    ...
    function StorageAdapter(model) {
      ...
      extend = function(x, y) {
        ...
        for (key in y) {
          value = y[key];
          _results.push(x[key] = value);
        }
        return _results;
      };
      if (this.constructor.ModelMixin) {
        extend(model, this.constructor.ModelMixin);
      }
      if (this.constructor.RecordMixin) {
        extend(model.prototype, this.constructor.RecordMixin);
      }
    }
    ...
    StorageAdapter.prototype.getRecordFromData = function(attributes, klass) {
      var record;
      if (klass == null) {
        klass = this.model;
      }
  ...
  Batman.RestStorage = (function(_super) {
    ...
    RestStorage.BaseMixin = {
      request: function(action, options, callback) {
        ...
        options.action = action;
        return this._doStorageOperation(options.method.toLowerCase(), this, options, callback);
      }
    };

    RestStorage.ModelMixin = $mixin({}, RestStorage.BaseMixin, {
    ...
    RestStorage.RecordMixin = $mixin({}, RestStorage.BaseMixin);
    ...
    RestStorage.prototype.perform = function(key, record, options, callback) {
      options || (options = {});
      $mixin(options, this.defaultRequestOptions);
