  ...
  Batman.Dispatcher = (function(_super) {
    ...
    Dispatcher.paramsFromArgument = function(argument) {
      ...
      resourceNameFromModel = function(model) {
        return helpers.camelize(helpers.pluralize(Batman.functionName(model)), true);
      };
...
(function() {
  ...
  Batman.Controller = (function(_super) {
    ...
    Controller.accessor('controllerName', function() {
      return this._controllerName || (this._controllerName = helpers.underscore(Batman.functionName(this.constructor).replace('Controller', '')));
    });
    ...
    Controller.prototype.contstructor = function() {
      ...
      this._actionFrames = [];
      return Controller.__super__.contstructor.apply(this, arguments);
    };
    ...
    Controller.prototype.executeAction = function(action, params) {
      ...
      Batman.developer.assert(this[action], "Error! Controller action " + (this.get('controllerName')) + "." + action + " couldn't be found!");
    ...
    Controller.prototype.redirect = function(url) {
      ...
      if (frame) {
        if (frame.actionTaken) {
          Batman.developer.warn("Warning! Trying to redirect but an action has already be taken during " + (this.get('controllerName')) + "." + (frame.action || this.get('action')) + "}");
        }
    ...
    Controller.prototype.render = function(options) {
      ...
      if (frame && frame.actionTaken && this._renderedYields[options.into]) {
        Batman.developer.warn("Warning! Trying to render but an action has already be taken during " + (this.get('controllerName')) + "." + action + " on yield " + options.into);
      }
      if (frame != null) {
        frame.actionTaken = true;
      }
      ...
      if (!options.view) {
        options.viewClass || (options.viewClass = ((_ref2 = Batman.currentApp) != null ? _ref2[helpers.camelize("" + (this.get('controllerName')) + "_" + action + "_view")] : void 0) || Batman.View);
        options.context || (options.context = this.get('_renderContext'));
        options.source || (options.source = helpers.underscore(this.get('controllerName') + '/' + action));
...
(function() {
  ...
  Batman.Model = (function(_super) {
    ...
    Model.urlNestsUnder = function() {
      ...
      childSegment = Batman.helpers.pluralize(Batman._functionName(this).toLowerCase());
    ...
    Model.prototype.toString = function() {
      return "" + (Batman.functionName(this.constructor)) + ": " + (this.get('id'));
    };
    ...
    Model.prototype.load = function(options, callback) {
      var callbackQueue, hasOptions, _ref, _ref1,
        _this = this;
      if (!callback) {
    ...
    Model.prototype.save = function(options, callback) {
      var endState, isNew, startState, storageOperation, _ref, _ref1, _ref2,
        _this = this;
      if (!callback) {
        _ref = [{}, options], options = _ref[0], callback = _ref[1];
      }
      if ((_ref1 = this.get('lifecycle').get('state')) === 'destroying' || _ref1 === 'destroyed') {
        if (typeof callback === "function") {
      ...
      return this.validate(function(error, errors) {
        var associations, creating, _ref3;
        ...
        if (_this.get('lifecycle').startTransition(startState)) {
          ...
          if (associations != null) {
            if ((_ref3 = associations.getByType('belongsTo')) != null) {
          ...
          return _this._doStorageOperation(storageOperation, {
            ...
            if (!err) {
              ...
              if (associations) {
                ...
                if ((_ref5 = associations.getByType('hasMany')) != null) {
    ...
    Model.prototype.validate = function(callback) {
      var args, count, errors, finishedValidation, key, validator, validators, _i, _j, _len, _len1, _ref;
    ...
    View.accessor('node', {
      ...
      set: function(_, node) {
        ...
        updateHTML = function(html) {
          if (html != null) {
            Batman.setInnerHTML(_this.get('node'), html);
    ...
    Association.prototype.getRelatedModel = function() {
      ...
      Batman.developer["do"](function() {
        if ((Batman.currentApp != null) && !relatedModel) {
          return Batman.developer.warn("Related model " + modelName + " hasn't loaded yet.");
        }
      });
      return relatedModel;
    };
...
(function() {
  ...
  Batman.StateMachine = (function(_super) {
    ...
    StateMachine.prototype.startTransition = function(event) {
...
(function() {
  ...
  Batman.HasManyAssociation = (function(_super) {
    ...
    function HasManyAssociation(model, label, options) {
      ...
      this.primaryKey = this.options.primaryKey || "id";
      this.foreignKey = this.options.foreignKey || ("" + (helpers.underscore(Batman.functionName(this.model))) + "_id");
    }
...
(function() {
  ...
  Batman.PolymorphicBelongsToAssociation = (function(_super) {
    ...
    PolymorphicBelongsToAssociation.prototype.getRelatedModelForType = function(type) {
      ...
      Batman.developer["do"](function() {
        if ((Batman.currentApp != null) && !relatedModel) {
          return Batman.developer.warn("Related model " + modelName + " for polymorhic association not found.");
        }
      });
      return relatedModel;
    };
...
(function() {
  ...
  Batman.PolymorphicHasManyAssociation = (function(_super) {
    ...
    PolymorphicHasManyAssociation.prototype.modelType = function() {
      return Batman.functionName(this.model);
    };
...
(function() {
  ...
  Batman.StorageAdapter = (function(_super) {
    ...
    StorageAdapter.prototype.storageKey = function(record) {
      ...
      return model.get('storageKey') || helpers.pluralize(helpers.underscore(Batman.functionName(model)));
    };
  ...
  Batman.DOM.AbstractBinding = (function(_super) {
    ...
    AbstractBinding.prototype.parseFilter = function() {
      ...
      while (get_dot_rx.test(keyPath)) {
        keyPath = keyPath.replace(get_dot_rx, "]['Batman.1']");
      }
