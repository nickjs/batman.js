...
(function() {
  ...
  Batman.Renderer = (function(_super) {
    ...
    Renderer.prototype.start = function() {
      ...
      return this.parseNodes(this.node);
    };

    Renderer.prototype.resume = function() {
      this.startTime = new Date;
      return this.parseNodes(this.resumeNode);
    };
    ...
    Renderer.prototype.parseNodes = function(node) {
      var skipChildren;
      ...
      while (node) {
        ...
        skipChildren = this.parseNode(node);
        node = this.nextNode(node, skipChildren);
      }
      return this.finish();
    };

    Renderer.prototype.parseNode = function(node) {
      var attr, attribute, binding, bindingDefinition, bindings, names, oldContext, reader, skipChildren, value, _k, _l, _len2, _len3, _ref1, _ref2, _ref3, _ref4,
        _this = this;
