(function() {
  ...
  Batman.config = {
    pathToApp: '/',
<<<<<<< HEAD:lib/dist/batman.jquery.js
    usePushState: true,
    pathToHTML: 'html',
...
=======
    ...
    usePushState: true,
    minificationErrors: true
>>>>>>> trying to add some tests:lib/dist/batman.node.js
  };
...
=======
    AssociationSet.prototype.load = function(options, callback) {
      ...
      return this.association.getRelatedModel().loadWithOptions(loadOptions, function(err, records) {
        if (!err) {
          _this.markAsLoaded();
        }
        return callback(err, _this);
      });
>>>>>>> Allow loading associated sets with options:lib/dist/batman.node.js
    };
