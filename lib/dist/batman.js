...
(function() {
  Batman.Event = (function() {
    ...
    Event.prototype.eachHandler = function(iterator) {
      var ancestor, key, _i, _len, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _results;
      ...
      if ((_ref2 = this.base) != null ? _ref2.isEventEmitter : void 0) {
        ...
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          ancestor = _ref4[_i];
          _results.push(ancestor.isEventEmitter && ((_ref5 = ancestor._batman) != null ? (_ref6 = _ref5.events) != null ? _ref6.hasOwnProperty(key) : void 0 : void 0) ? (_ref7 = ancestor.event(key, false)) != null ? (_ref8 = _ref7.handlers) != null ? _ref8.slice().forEach(iterator) : void 0 : void 0 : void 0);
        }
        return _results;
      }
    };
...
(function() {
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.eachObserver = function(iterator) {
      var ancestor, handlers, key, object, property, _i, _j, _len, _len2, _ref, _ref2, _results;
      key = this.key;
        ...
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          ...
          _results.push((function() {
            ...
            if (ancestor.isObservable && ancestor.hasProperty(key)) {
              ...
              handlers = (_ref3 = property.changeEvent().handlers) != null ? _ref3.slice() : void 0;
              if (handlers) {
                _results2 = [];
                for (_k = 0, _len3 = handlers.length; _k < _len3; _k++) {
                  object = handlers[_k];
                  _results2.push(iterator(object));
                }
                return _results2;
              }
            }
    ...
    Property.prototype.updateSourcesFromTracker = function() {
      var handler, newSources, source, _i, _j, _len, _len2, _ref, _ref2, _results;
...
(function() {
  ...
  Batman.Renderer = (function() {
    ...
    Renderer.prototype.parseNode = function(node) {
      var attr, attribute, binding, bindingDefinition, bindings, names, nextNode, oldContext, reader, skipChildren, value, _j, _k, _len3, _len4, _ref2, _ref3, _ref4, _ref5;
      ...
      if (node.getAttribute && node.attributes) {
        ...
        for (_k = 0, _len4 = _ref4.length; _k < _len4; _k++) {
          _ref5 = _ref4[_k], name = _ref5[0], attr = _ref5[1], value = _ref5[2];
          ...
          if (binding instanceof Batman.RenderContext) {
            ...
            Batman.DOM.onParseExit(node, __bind(function() {
    ...
    Renderer.prototype.nextNode = function(node, skipChildren) {
      var children, nextParent, parentSibling, sibling, _ref2, _ref3;
      if (!skipChildren) {
      ...
      if ((_ref2 = Batman.DOM.onParseExit(node)) != null) {
      ...
      while (nextParent = nextParent.parentNode) {
        ...
        if ((_ref3 = Batman.DOM.onParseExit(nextParent)) != null) {
          _ref3.forEach(function(callback) {
            return callback();
          });
        }
  ...
  Batman.DOM.SelectBinding = (function() {
    ...
    SelectBinding.prototype.childBindingAdded = function(binding) {
      ...
      if (binding instanceof Batman.DOM.CheckedBinding) {
        binding.on('dataChange', dataChangeHandler = __bind(function() {
          return this.nodeChange();
        }, this));
        binding.on('die', __bind(function() {
          binding.forget('dataChange', dataChangeHandler);
          return this.selectedBindings.remove(binding);
        }, this));
        this.selectedBindings.add(binding);
      } else if (binding instanceof Batman.DOM.IteratorBinding) {
        binding.on('nodeAdded', dataChangeHandler = __bind(function() {
...
(function() {
  ...
  Batman.DOM.RouteBinding = (function() {
    ...
    RouteBinding.prototype.bind = function() {
      ...
      return Batman.DOM.events.click(this.node, __bind(function(node, event) {
        var params;
...
(function() {
  ...
  Batman.DOM.StyleBinding = (function() {
    ...
    StyleBinding.prototype.dataChange = function(value) {
      var colonSplitCSSValues, cssName, key, style, _i, _len, _ref, _ref2, _results;
      if (!value) {
        this.resetStyles();
        return;
      }
...
(function() {
  ...
  Batman.DOM.IteratorBinding = (function() {
    ...
    function IteratorBinding(definition) {
      ...
      Batman.DOM.onParseExit(sourceNode.parentNode, __bind(function() {
    ...
    IteratorBinding.prototype.handleArrayChanged = function(newItems) {
      var existingNode, index, newItem, node, nodeAtIndex, parentNode, startIndex, unseenNodeMap, _len;
      parentNode = this.parentNode();
      startIndex = this._getStartNodeIndex() + 1;
      unseenNodeMap = this.nodeMap.merge();
      if (newItems) {
        for (index = 0, _len = newItems.length; index < _len; index++) {
    ...
    IteratorBinding.prototype._newNodeForItem = function(newItem) {
      ...
      renderer.once('rendered', __bind(function() {
        var _ref;
        this._nodesToBeRendered.remove(newNode);
        if ((_ref = this._nodesToBeRemoved) != null ? _ref.has(newNode) : void 0) {
          this._nodesToBeRemoved.remove(newNode);
          this._removeItem(newItem);
        } else {
          Batman.DOM.propagateBindingEvents(newNode);
          this.fire('nodeAdded', newNode, newItem);
        }
        return this.parentRenderer.allowAndFire('rendered');
      }, this));
      return newNode;
...
(function() {
  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.render = function(options) {
      var action, frame, view, _ref, _ref2;
      if (options == null) {
        options = {};
      }
      ...
      if (view) {
        ...
        view.once('ready', __bind(function() {
          var _ref3;
...
(function() {
  ...
  Batman.Model = (function() {
    ...
    Model.validate = function() {
      ...
      if (typeof optionsOrFunction === 'function') {
        ...
        for (_j = 0, _len = _ref.length; _j < _len; _j++) {
          ...
          _results.push((matches = validatorClass.matches(optionsOrFunction)) ? validators.push({
            keys: keys,
    ...
    Model.loadWithOptions = function(options, callback) {
      ...
      return this._doStorageOperation('readAll', options, __bind(function(err, records, env) {
        ...
        if (err != null) {
          ...
          mappedRecords = this._mapIdentities(records);
          this.fire('loaded', mappedRecords, env);
    ...
    Model._mapIdentities = function(records) {
      var existing, id, index, newRecords, record, _len, _ref, _ref2;
      newRecords = [];
      for (index = 0, _len = records.length; index < _len; index++) {
        ...
        if (!((id = record.get('id')) != null)) {
          ...
          existing._withoutDirtyTracking(function() {
            var _ref2;
            return this.updateAttributes(((_ref2 = record.get('attributes')) != null ? _ref2.toObject() : void 0) || {});
          });
...
(function() {
  ...
  Batman.DOM.InsertionBinding = (function() {
    ...
    function InsertionBinding(definition) {
      ...
      Batman.DOM.onParseExit(this.node, __bind(function() {
        this.bind();
        if (this.placeholderNode != null) {
          return Batman.DOM.trackBinding(this, this.placeholderNode);
        }
      }, this));
    }
  ...
  Batman.View = (function() {
    ...
    View.accessor('argumentBindings', function() {
      return new Batman.TerminalAccessible(__bind(function(key) {
        ...
        return this[bindingKey] = new Batman.DOM.ViewArgumentBinding(definition);
      }, this));
    });
    View.accessor('html', {
      get: function() {
    ...
    function View(options) {
      ...
      Batman.Property.withoutTracking(__bind(function() {
        return this.observeAndFire('readyToRender', __bind(function(ready) {
          if (ready) {
            return this.render();
          }
        }, this));
    ...
    View.prototype.render = function() {
      ...
      return this._renderer.once('rendered', __bind(function() {
...
(function() {
  ...
  Batman.DOM.Yield = Yield = (function() {
    ...
    Yield.queued = function(fn) {
      return function() {
        ...
        if (this.containerNode != null) {
          ...
          return handler = this.observe('containerNode', __bind(function() {
            var result;
            result = fn.apply(this, args);
            this.forget('containerNode', handler);
            return result;
          }, this));
        }
      };
...
(function() {
  ...
  Batman.extend(Batman.DOM, {
    ...
    removeNode: function(node) {
      ...
      if ((_ref3 = node.parentNode) != null) {
        _ref3.removeChild(node);
      }
