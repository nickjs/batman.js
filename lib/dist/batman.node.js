...
(function() {
  ...
  Batman.IteratorView = (function(_super) {
    ...
    IteratorView.prototype.insertItem = function(item, targetIndex) {
      var iterationView;
...
(function() {
  ...
  Batman.DOM.IteratorBinding = (function(_super) {
    ...
    IteratorBinding.prototype.handleItemsAdded = function(addedItems, addedIndexes) {
      ...
      if (addedIndexes) {
        for (i = _i = 0, _len = addedItems.length; _i < _len; i = ++_i) {
          item = addedItems[i];
          this.backingView.insertItem(item, addedIndexes[i]);
        }
      } else {
    ...
    IteratorBinding.prototype.handleItemsRemoved = function(removedItems, removedIndexes) {
      ...
      if (removedIndexes) {
        _results = [];
        for (i = _i = 0, _len = removedItems.length; _i < _len; i = ++_i) {
          item = removedItems[i];
          _results.push(this.backingView.subviews.at(removedIndexes[i]).die());
        }
        return _results;
      } else {
        _results1 = [];
        for (_j = 0, _len1 = removedItems.length; _j < _len1; _j++) {
          item = removedItems[_j];
