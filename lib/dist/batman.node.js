  ...
  Batman.StorageAdapter = (function(_super) {
    ...
    StorageAdapter.NotAllowedError = (function(_super1) {
      ...
      function NotAllowedError(message) {
        NotAllowedError.__super__.constructor.call(this, message || "Operation not allowed by the storage adapter!");
      }
    ...
    StorageAdapter.UnprocessableEntityError = (function(_super1) {

      __extends(UnprocessableEntityError, _super1);

      UnprocessableEntityError.prototype.name = "UnprocessableEntityError";

      function UnprocessableEntityError(message) {
        UnprocessableEntityError.__super__.constructor.call(this, message || "Storage adapter could not process the record!");
      }
...
(function() {
  ...
  Batman.RestStorage = (function(_super) {
    ...
    RestStorage.prototype.after('all', function(env, next) {
      if (env.error != null) {
        env.error = this._errorFor(env.error);
      }
      return next();
    });
    ...
    RestStorage._statusCodeErrors = {
      ...
      '422': RestStorage.UnprocessableEntityError,
      '500': RestStorage.InternalStorageError,
      '501': RestStorage.NotImplementedError
    };

    RestStorage.prototype._errorFor = function(error) {
      var errorClass;
...
(function() {
  ...
  Batman.Controller = (function(_super) {
    ...
    Controller.catchError = function() {
      var currentHandlers, error, errors, handlers, options, _base, _i, _j, _len, _ref, _ref1, _results;
      errors = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), options = arguments[_i++];
      Batman.initializeObject(this);
      if ((_ref = (_base = this._batman).errorHandlers) == null) {
        _base.errorHandlers = new Batman.SimpleHash;
      }
      handlers = options["with"] instanceof Array ? options["with"] : Array(options["with"]);
      _results = [];
      for (_j = 0, _len = errors.length; _j < _len; _j++) {
        error = errors[_j];
        currentHandlers = (_ref1 = this._batman.errorHandlers.get(error)) != null ? _ref1 : [];
    ...
    Controller.prototype.errorHandler = function(callback) {
      var _this = this;
      return function() {
        var args, err, handled, _ref;
        err = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
        if (err) {
          handled = false;
          if ((_ref = _this.constructor._batman.getAll('errorHandlers')) != null) {
              ...
              return hash.forEach(function(key, value) {
                ...
                if (err instanceof key) {
                  ...
                  for (_i = 0, _len = value.length; _i < _len; _i++) {
                    handler = value[_i];
                    _results.push(handler.call(_this, err));
                  }
                  return _results;
                }
              });
...
(function() {
  ...
  Batman.RailsStorage = (function(_super) {
    ...
    RailsStorage.prototype.after('update', 'create', function(env, next) {
      ...
      if (error) {
        if (error instanceof Batman.StorageAdapter.UnprocessableEntityError || ((_ref = error.request) != null ? _ref.get('status') : void 0) === 422) {
          try {
