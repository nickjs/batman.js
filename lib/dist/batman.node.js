  ...
  Batman.RestStorage = (function(_super) {
    ...
    RestStorage.prototype.urlForRecord = function(record, env) {
      ...
      if ((_ref = env.options) != null ? _ref.recordUrl : void 0) {
        url = typeof env.options.recordUrl === 'function' ? env.options.recordUrl.call(record) : env.options.recordUrl;
      } else if (record.url) {
    ...
    RestStorage.prototype.urlForCollection = function(model, env) {
      var url, _base, _ref;
      url = ((_ref = env.options) != null ? _ref.collectionUrl : void 0) ? (typeof (_base = env.options).collectionUrl === "function" ? _base.collectionUrl() : void 0) || env.options.collectionUrl : model.url ? this._execWithOptions(model, 'url', env.options) : this._defaultCollectionUrl(model, env.options);
...
(function() {
  ...
  Batman.HasOneProxy = (function(_super) {
    ...
    HasOneProxy.prototype.fetchFromRemote = function(callback) {
      ...
      if (this.association.options.customUrl) {
        loadOptions.collectionUrl = this.association.options.customUrl;
      }
...
(function() {
  ...
  Batman.BelongsToProxy = (function(_super) {
    ...
    BelongsToProxy.prototype.fetchFromRemote = function(callback) {
      ...
      loadOptions = {};
      if (this.association.options.customUrl) {
        loadOptions.recordUrl = this.association.options.customUrl;
      }
