...
(function() {
  ...
  Batman.DOM.IteratorBinding = (function(_super) {
    ...
    IteratorBinding.prototype.handleArrayChanged = function(newItems) {
      var existingNode, fragment, index, newItem, node, nodeAtIndex, parentNode, startIndex, unseenNodeMap, _i, _len,
        _this = this;
...
(function() {
  Batman.RouteMap = (function() {
    ...
    RouteMap.prototype.routeForParams = function(params) {
      return this.cachedRoute(params);
    };
    ...
    RouteMap.prototype.cachedRoute = function(params) {
      var path, route, _i, _len, _ref;

      path = typeof params === 'string' ? params : params.path != null ? params.path : "" + params.controller + "#" + params.action;
      this._cachedRoutes || (this._cachedRoutes = {});
      if (this._cachedRoutes[path]) {
        return this._cachedRoutes[path];
      } else {
        _ref = this.childrenByOrder;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          route = _ref[_i];
          if (route.test(params)) {
            return (this._cachedRoutes[path] = route);
          }
        }
      }
    };
...
(function() {
  ...
  Batman.extend(Batman, {
    ...
    acceptData: function(elem) {
      ...
      return elem.___acceptData || (elem.___acceptData = !(match = Batman.noData[elem.nodeName]) || !(match === true) || elem.getAttribute("classid") !== match);
    }
  });
