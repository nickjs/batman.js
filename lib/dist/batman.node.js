    ...
    Controller.prototype.render = function(options) {
      ...
      if (view) {
        ...
        view.on('ready', function() {
          ...
          return frame != null ? frame.actionFinish() : void 0;
        });
      }
      return view;
    };
...
(function() {
  ...
  Batman.ControllerActionFrame = (function(_super) {
    ...
    ControllerActionFrame.prototype.actionTaken = false;

    ControllerActionFrame.prototype.remainingActions = 0;
    ...
    ControllerActionFrame.prototype.actionStart = function(options) {
      if (options == null) {
        options = {};
      }
      if (!options.internal) {
      ...
      this._changeActionsCounter(1);
      return true;
    };

    ControllerActionFrame.prototype.actionFinish = function() {
      this._changeActionsCounter(-1);
      return true;
    };

    ControllerActionFrame.prototype.immediateActionTaken = function(options) {
      this.actionStart(options);
      this.actionFinish(options);
      return true;
    };

    ControllerActionFrame.prototype._changeActionsCounter = function(delta) {
      var _ref;
      this.remainingActions += delta;
      if (this.remainingActions === 0) {
        this.fire('complete');
      }
      if ((_ref = this.parentFrame) != null) {
        _ref._changeActionsCounter(delta);
      }
    };
