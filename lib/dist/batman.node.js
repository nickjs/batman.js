...
(function() {
  ...
  Batman.Controller = (function(_super) {
    ...
    Controller.catchError = function() {
      var error, errorHandlers, errors, handlers, options, _i, _j, _len, _results;
      errors = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), options = arguments[_i++];
      errorHandlers = this.getOrSet('errorHandlers', function() {
      ...
      for (_j = 0, _len = errors.length; _j < _len; _j++) {
        error = errors[_j];
        _results.push(errorHandlers.set(error, handlers));
      }
      return _results;
    };
    ...
    Controller.prototype.errorHandler = function(callback) {
      ...
      return function() {
        ...
        if (err) {
          handled = false;
          if ((_ref = _this.constructor.get('errorHandlers')) != null) {
            _ref.forEach(function(key, value) {
