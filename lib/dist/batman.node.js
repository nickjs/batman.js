(function() {
  ...
  Batman.container = typeof exports !== "undefined" && exports !== null ? (global.Batman = Batman, global) : (window.Batman = Batman, window);
...
(function() {
  ...
  Batman.Route = (function(_super) {
    ...
    Route.prototype.paramsFromPath = function(pathAndQuery) {
      ...
      return $extend(params, uri.queryParams());
    };
...
(function() {
  ...
  Batman.URI = (function() {
    var attributes, encodeComponent, plus, queryParser, r20, strictParser;
    ...
    URI.paramsFromQuery = function(query) {
      var decode, params;
      params = {};
      decode = this.decodeQueryComponent;
      query.replace(queryParser, function(_, key, value) {
        if (key) {
          return params[decode(key)] = decode(value);
        }
      });
      return params;
    };

    URI.queryFromParams = function(params) {
      var encode, key, value;
      encode = this.encodeQueryComponent;
      return ((function() {
        var _results;
        _results = [];
        for (key in params) {
    ...
    URI.decodeQueryComponent = function(str) {
    ...
    URI.encodeQueryComponent = function(str) {
...
(function() {
  ...
  Batman.I18N.LocalesStorage = (function(_super) {
    ...
    LocalesStorage.name = 'LocalesStorage';
