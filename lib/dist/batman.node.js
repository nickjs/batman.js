...
(function() {
  ...
  Batman.DOM.readers = {
    ...
    context: function(definition) {
      return definition.context.descendWithKey(definition.keyPath);
    },
...
(function() {
  ...
  Batman.DOM.events = {
    ...
    change: function(node, callback, context) {
      ...
      for (_i = 0, _len = eventNames.length; _i < _len; _i++) {
        ...
        _results.push(Batman.DOM.addEventListener(node, eventName, callbackForEvent.change(callback, context)));
      }
      return _results;
    },
    isEnter: function(ev) {
    ...
    other: function(node, eventName, callback, context) {
      return Batman.DOM.addEventListener(node, eventName, callbackForEvent.other(callback, context));
    }
  };
  ...
  callbackForEvent = {
    click: function(block, context) {
      return function(event) {
        if (event.metaKey || event.ctrlKey) {
          return;
        }
        Batman.DOM.preventDefault(event);
        if (!Batman.DOM.eventIsAllowed(event.type, event)) {
          return;
        }
        return block(event.target, event, context);
      };
    },
    change: function(block, context) {
      return function(event) {
        return block(event.target, event, context);
      };
    },
    keyDown: function(block, context) {
      return function(event) {
        if (Batman.DOM.events.isEnter(event)) {
          return Batman.DOM._keyCapturingNode = event.target;
        }
      };
    },
    keyUp: function(block, context) {
      return function(event) {
        var node;
        if (Batman.DOM.events.isEnter(event)) {
          node = event.target;
    ...
    submit: function(block, context) {
      return function(event) {
        Batman.DOM.preventDefault(event);
        return block(event.target, event, context);
      };
    },
    other: function(block, context) {
      return function(event) {
        return block(event.target, event, context);
      };
    }
...
(function() {
  ...
  Batman.DOM.attrReaders = {
    ...
    context: function(definition) {
      return definition.context.descendWithKey(definition.keyPath, definition.attr);
    },
...
(function() {
  ...
  Batman.DOM.ShowHideBinding = (function(_super) {
    ...
    ShowHideBinding.prototype.onlyObserve = 'data';
...
(function() {
  ...
  Batman.DOM.EventBinding = (function(_super) {
    ...
    EventBinding.prototype.onlyObserve = 'none';
