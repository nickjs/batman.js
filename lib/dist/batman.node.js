  ...
  Batman.URI = (function() {
    ...
    */
    ...
    URI.prototype.queryString = function() {
      ...
      string = (function() {
        var _ref, _results;
        _ref = this.queryParams;
        _results = [];
        for (k in _ref) {
          v = _ref[k];
          k = this.constructor.encodeQueryComponent(k);
          if (v) {
            v = this.constructor.encodeQueryComponent(v);
          }
          if (v != null) {
            _results.push("" + k + "=" + v);
          } else {
    ...
    URI.prototype.toString = function() {
      ...
      return [this.protocol, "://", this.user, this.password ? ":" + this.password : void 0, this.user ? "@" : void 0, this.hostname, this.port ? ":" + this.port : void 0, this.path, query ? "?" + query : void 0, this.hash ? "#" + this.hash : void 0].join("");
    };
