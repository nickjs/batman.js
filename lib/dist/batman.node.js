  ...
  Batman.View = (function(_super) {
    ...
    View.option = function() {
      ...
      return this.accessor.apply(this, __slice.call(keys).concat([{
        ...
        set: function(key, value) {
          var _ref;
          return (_ref = this.get(this._argumentBindingKey(key))) != null ? _ref.set('filteredValue', value) : void 0;
        },
        unset: function(key) {
          var _ref;
          return (_ref = this.get(this._argumentBindingKey(key))) != null ? _ref.unset('filteredValue') : void 0;
        }
      }]));
    };
