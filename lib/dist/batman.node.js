...
(function() {
  ...
  Batman.SimpleHash = (function() {
    ...
    SimpleHash.prototype._getProperty = function(key) {
      return this._storage["_" + key];
    };

    SimpleHash.prototype._setProperty = function(key, val) {
      key = "_" + key;
...
(function() {
  ...
  Batman.SimpleSet = (function() {
    ...
    SimpleSet.prototype._indexOfItem = function(givenItem) {
      return this._storage.indexOf(givenItem);
    };
...
(function() {
  ...
  Batman.Observable = {
    ...
    property: function(key) {
      ...
      return properties._getProperty(key) || properties._setProperty(key, new propertyClass(this, key));
    },
    get: function(key) {
