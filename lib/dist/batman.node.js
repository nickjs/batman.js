...
(function() {
  ...
  Batman.DOM.EventBinding = (function(_super) {
    ...
    function EventBinding(node, eventName, key, context) {
      ...
      callback = function(e) {
        var _ref, _ref1;
        e.stopBatmanPropagation = function() {
          return e.__stopBatmanPropagation = true;
        };
        if ((_ref = Batman.currentApp) != null) {
          if (typeof _ref.clickEvent === "function") {
            _ref.clickEvent(e, node);
          }
        }
        if (e.__stopBatmanPropagation) {
          return;
        }
        return (_ref1 = _this.get('filteredValue')) != null ? _ref1.apply(_this.get('callbackContext'), arguments) : void 0;
      };
