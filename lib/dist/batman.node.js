...
(function() {
  ...
  Batman._Batman = _Batman = (function() {
    ...
    _Batman.prototype.allAncestors = function() {
      var isClass, parent, proto, results, _ref, _ref2;
      results = [];
...
(function() {
  ...
  Batman.Inflector = (function() {
    ...
    Inflector.prototype.humanize = function(word) {
      var regex, replace_string, _i, _len, _ref, _ref2;
      _ref = this._human;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        _ref2 = _ref[_i], regex = _ref2[0], replace_string = _ref2[1];
        if (regex.test(word)) {
          return word.replace(regex, replace_string);
        }
      }
...
(function() {
  Batman.Event = (function() {
    ...
    Event.prototype.eachHandler = function(iterator) {
      var ancestor, key, _i, _len, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      if ((_ref = this.handlers) != null) {
        _ref.slice().forEach(iterator);
      }
      if ((_ref2 = this.base) != null ? _ref2.isEventEmitter : void 0) {
        key = this.key;
        _ref4 = (_ref3 = this.base._batman) != null ? _ref3.ancestors() : void 0;
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          ancestor = _ref4[_i];
          if (ancestor.isEventEmitter && ((_ref5 = ancestor._batman) != null ? (_ref6 = _ref5.events) != null ? _ref6.hasOwnProperty(key) : void 0 : void 0)) {
            if ((_ref7 = ancestor.event(key, false)) != null) {
              if ((_ref8 = _ref7.handlers) != null) {
                _ref8.slice().forEach(iterator);
              }
            }
          }
        }
...
(function() {
  ...
  Batman.EventEmitter = {
    ...
    event: function(key, createEvent) {
      var ancestor, eventClass, events, existingEvent, newEvent, _base, _i, _len, _ref, _ref2, _ref3, _ref4;
      if (createEvent == null) {
        createEvent = true;
      }
      ...
      if ((_ref = this._batman.events) != null ? _ref.hasOwnProperty(key) : void 0) {
        ...
        _ref2 = this._batman.ancestors();
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          ancestor = _ref2[_i];
          existingEvent = (_ref3 = ancestor._batman) != null ? (_ref4 = _ref3.events) != null ? _ref4[key] : void 0 : void 0;
          if (existingEvent) {
            break;
          }
        }
  ...
  Batman.SimpleSet = (function() {
    ...
    SimpleSet.prototype.addAndRemove = function(itemsToAdd, itemsToRemove) {
      ...
      if (this.fire) {
        ...
        if (itemsAdded.length > 0) {
          this.fire('itemsWereAdded', itemsAdded);
        }
        if (itemsRemoved.length > 0) {
          this.fire('itemsWereRemoved', itemsRemoved);
        }
      }
      return {
        added: itemsAdded,
    ...
    SimpleSet.prototype.clear = function() {
      ...
      if (this.fire && items.length !== 0) {
        this.fire('change', this, this);
        this.fire('itemsWereRemoved', items);
      }
      return items;
    };
...
(function() {
  ...
  Batman.Property = (function() {
    __extends(Property, Batman.PropertyEvent);
    ...
    Property.accessorForBaseAndKey = function(base, key) {
      var accessor, ancestor, _bm, _i, _len, _ref, _ref2, _ref3, _ref4;
      if ((_bm = base._batman) != null) {
        ...
        if (!accessor) {
          ...
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            ancestor = _ref2[_i];
            accessor = (_ref3 = ancestor._batman) != null ? (_ref4 = _ref3.keyAccessors) != null ? _ref4.get(key) : void 0 : void 0;
            if (accessor) {
              break;
            }
          }
    ...
    Property.prototype.eachObserver = function(iterator) {
      var ancestor, handlers, key, object, property, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
      key = this.key;
      ...
      if (this.base.isObservable) {
        _ref2 = this.base._batman.ancestors();
        for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
          ancestor = _ref2[_j];
          if (ancestor.isObservable && ancestor.hasProperty(key)) {
            property = ancestor.property(key);
            handlers = (_ref3 = property.handlers) != null ? _ref3.slice() : void 0;
            if (handlers) {
              for (_k = 0, _len3 = handlers.length; _k < _len3; _k++) {
                object = handlers[_k];
                iterator(object);
              }
            }
    ...
    Property.prototype.updateSourcesFromTracker = function() {
      var handler, newSources, source, _i, _j, _len, _len2, _ref, _ref2;
    ...
    Property.prototype.sourceChangeHandler = function() {
      ...
      Batman.developer["do"](__bind(function() {
        return this._sourceChangeHandler.property = this;
      }, this));
...
(function() {
  ...
  Batman.DOM.events = {
    ...
    isEnter: function(ev) {
      var _ref, _ref2;
      return ((13 <= (_ref = ev.keyCode) && _ref <= 14)) || ((13 <= (_ref2 = ev.which) && _ref2 <= 14)) || ev.keyIdentifier === 'Enter' || ev.key === 'Enter';
    },
  ...
  Batman.DOM.eventIsAllowed = function(eventName, event) {
    var delegate, _ref, _ref2;
    if (delegate = (_ref = Batman.currentApp) != null ? (_ref2 = _ref.shouldAllowEvent) != null ? _ref2[eventName] : void 0 : void 0) {
...
(function() {
  ...
  promiseWrapper = function(fetcher) {
    return function(defaultAccessor) {
      return {
        get: function(key) {
          var asyncDeliver, existingValue, newValue, _base, _base2, _ref, _ref2;
          ...
          if ((_ref2 = (_base2 = this._batman.promises)[key]) == null) {
            _base2[key] = __bind(function() {
              var deliver, returnValue;
              deliver = __bind(function(err, result) {
                if (asyncDeliver) {
                  this.set(key, result);
                }
...
(function() {
  ...
  Batman.Renderer = (function() {
    var bindingSortOrder, bindingSortPositions, name, pos, viewBackedBindings, _len;
    __extends(Renderer, Batman.Object);
    function Renderer(node, view) {
      this.node = node;
      this.view = view;
    ...
    for (pos = 0, _len = bindingSortOrder.length; pos < _len; pos++) {
    ...
    Renderer.prototype.parseTree = function(root) {
      var skipChildren;
      while (root) {
    ...
    Renderer.prototype.parseNode = function(node) {
      var attr, attrIndex, attribute, backingView, binding, bindingDefinition, bindings, isViewBacked, reader, value, _i, _j, _len2, _len3, _ref, _ref2, _ref3, _ref4;
      isViewBacked = false;
      if (node.getAttribute && node.attributes) {
        ...
        for (_i = 0, _len2 = _ref.length; _i < _len2; _i++) {
          attribute = _ref[_i];
          if (((_ref2 = attribute.nodeName) != null ? _ref2.substr(0, 5) : void 0) !== "data-") {
            continue;
          }
        ...
        for (_j = 0, _len3 = _ref3.length; _j < _len3; _j++) {
          _ref4 = _ref3[_j], name = _ref4[0], attr = _ref4[1], value = _ref4[2];
          ...
          if (binding != null ? binding.ready : void 0) {
            this.view.once('ready', (function(binding) {
              return function() {
                return binding.ready.call(binding);
              };
            })(binding));
          }
...
(function() {
  ...
  Batman.StorageAdapter = (function() {
    ...
    StorageAdapter.NotAllowedError = (function() {
      __extends(NotAllowedError, StorageAdapter.StorageError);
    ...
    StorageAdapter.NotAcceptableError = (function() {
      __extends(NotAcceptableError, StorageAdapter.StorageError);
    ...
    StorageAdapter.UnprocessableRecordError = (function() {
      __extends(UnprocessableRecordError, StorageAdapter.StorageError);
    ...
    StorageAdapter.InternalStorageError = (function() {
      __extends(InternalStorageError, StorageAdapter.StorageError);
    ...
    StorageAdapter.NotImplementedError = (function() {
      __extends(NotImplementedError, StorageAdapter.StorageError);
...
(function() {
  ...
  Batman.RestStorage = (function() {
    ...
    RestStorage.CommunicationError = (function() {
      __extends(CommunicationError, RestStorage.StorageError);
    ...
    RestStorage.ModelMixin = Batman.extend({}, RestStorage.BaseMixin, {
      urlNestsUnder: function() {
        ...
        this.url = function(options) {
          var childSegment, key, parentID, plural;
        ...
        return this.prototype.url = function() {
          var childSegment, id, key, parentID, plural, url;
...
(function() {
  ...
  Batman.LocalStorage = (function() {
    ...
    LocalStorage.prototype.before('read', 'create', 'update', 'destroy', LocalStorage.skipIfError(function(env, next) {
      if (env.action === 'create') {
        env.id = env.subject.get('id') || env.subject._withoutDirtyTracking(__bind(function() {
          return env.subject.set('id', this.nextIdForRecord(env.subject));
        }, this));
      } else {
...
(function() {
  ...
  Batman.NamedRouteQuery = (function() {
    ...
    NamedRouteQuery.accessor('withHash', function() {
      return new Batman.Accessible(__bind(function(hashValue) {
        return this.withHash(hashValue);
      }, this));
    });
...
(function() {
  ...
  Batman.Dispatcher = (function() {
    ...
    Dispatcher.prototype.dispatch = function(params, paramsMixin) {
      var error, inferredParams, path, route, _ref, _ref2;
...
(function() {
  ...
  Batman.Route = (function() {
    ...
    Route.prototype.paramsFromPath = function(pathAndQuery) {
      var index, match, matches, name, namedArguments, params, uri, _len;
    ...
    Route.prototype.pathFromParams = function(argumentParams) {
      var hash, key, name, newPath, params, path, query, regexp, regexps, _i, _j, _len, _len2, _ref, _ref2;
    ...
    Hash.prototype.update = Hash.mutation(function(object) {
      ...
      this._preventMutationEvents(function() {
        return Batman.forEach(object, __bind(function(k, v) {
          if (this.hasKey(k)) {
            changedKeys.push(k);
            changedOldValues.push(this.get(k));
            return changedNewValues.push(this.set(k, v));
          } else {
            addedKeys.push(k);
            return addedValues.push(this.set(k, v));
          }
        }, this));
      });
      ...
      this._preventMutationEvents(function() {
        this.forEach(__bind(function(k) {
          if (!Batman.objectHasKey(object, k)) {
            removedKeys.push(k);
            return removedValues.push(this.unset(k));
          }
        }, this));
        return Batman.forEach(object, __bind(function(k, v) {
          if (this.hasKey(k)) {
...
(function() {
  ...
  Batman.RenderCache = (function() {
    ...
    RenderCache.prototype.viewForOptions = function(options) {
      ...
      return this.getOrSet(options, __bind(function() {
        return this._newViewFromOptions(Batman.extend({}, options));
      }, this));
    };
...
(function() {
  ...
  Batman.Controller = (function() {
    ...
    Controller.prototype.errorHandler = function(callback) {
      ...
      return __bind(function(err, result, env) {
        if (err) {
    ...
    Controller.prototype.handleError = function(error) {
      ...
      if ((_ref = this.constructor._batman.getAll('errorHandlers')) != null) {
        _ref.forEach(__bind(function(hash) {
          return hash.forEach(__bind(function(key, value) {
            ...
            if (error instanceof key) {
              ...
              for (_i = 0, _len = value.length; _i < _len; _i++) {
                handler = value[_i];
                _results.push(handler.call(this, error));
              }
              return _results;
            }
          }, this));
    ...
    Controller.prototype.executeAction = function(action, params) {
      var frame, oldRedirect, parentFrame, result, _ref, _ref2;
      if (params == null) {
    ...
    Controller.prototype.render = function(options) {
      var action, frame, view, yieldName, _ref, _ref2, _ref3, _ref4, _ref5;
      if (options == null) {
        options = {};
      }
      ...
      if (view) {
        ...
        if ((_ref2 = Batman.DOM.Yield.withName(yieldName).contentView) != null) {
          _ref2.die();
        }
        ...
        if ((_ref3 = Batman.currentApp) != null) {
          if ((_ref4 = _ref3.layout) != null) {
            if ((_ref5 = _ref4.subviews) != null) {
              _ref5.add(view);
            }
          }
        }
    ...
    Controller.accessor('viewContext', function() {
      return this.viewContext || (this.viewContext = new Batman.View({
        controller: this
      }));
    });
    ...
    Controller.prototype._runFilters = function(action, params, filters) {
      var block, options, _i, _len, _ref, _results;
      if (filters = (_ref = this.constructor._batman) != null ? _ref.get(filters) : void 0) {
        ...
        for (_i = 0, _len = filters.length; _i < _len; _i++) {
          ...
          block = options.block;
          _results.push(typeof block === 'function' ? block.call(this, params) : typeof this[block] === "function" ? this[block](params) : void 0);
        }
        return _results;
      }
    };
...
(function() {
  ...
  Batman.Set = (function() {
    ...
    _ref = ['add', '_add', 'remove', '_remove', 'addAndRemove', 'clear', 'replace', 'indexedBy', 'indexedByUnique', 'sortedBy', 'equality', '_indexOfItem'];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      k = _ref[_i];
  ...
  Batman.SetProxy = (function() {
    ...
    function SetProxy(base) {
      ...
      if (typeof (_base = this.base).on === "function") {
        _base.on('itemsWereAdded', __bind(function(items) {
          this.set('length', this.base.length);
          return this.fire('itemsWereAdded', items);
        }, this));
      }
      if (typeof (_base2 = this.base).on === "function") {
        _base2.on('itemsWereRemoved', __bind(function(items) {
          this.set('length', this.base.length);
          return this.fire('itemsWereRemoved', items);
        }, this));
      }
    }
    ...
    _ref = ['add', 'remove', 'addAndRemove', 'find', 'clear', 'has', 'merge', 'toArray', 'isEmpty', 'indexedBy', 'indexedByUnique', 'sortedBy'];
    _fn = __bind(function(k) {
      return this.prototype[k] = function() {
        var _ref2;
...
(function() {
  ...
  Batman.BinarySetOperation = (function() {
    ...
    BinarySetOperation.prototype._setup = function(set, opposite) {
      set.on('itemsWereAdded', __bind(function(items) {
        return this._itemsWereAddedToSource.apply(this, [set, opposite].concat(__slice.call(items)));
      }, this));
      set.on('itemsWereRemoved', __bind(function(items) {
...
(function() {
  ...
  Batman.SetComplement = (function() {
    __extends(SetComplement, Batman.BinarySetOperation);
    function SetComplement() {
      SetComplement.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  Batman.StateMachine = (function() {
    ...
    StateMachine.transitions = function(table) {
      var definePredicate, fromState, k, object, predicateKeys, toState, transitions, v, _ref;
      for (k in table) {
        v = table[k];
        if (v.from && v.to) {
          object = {};
      ...
      predicateKeys = [];
      definePredicate = __bind(function(state) {
        var key;
  ...
  Batman.DelegatingStateMachine = (function() {
    __extends(DelegatingStateMachine, Batman.StateMachine);
...
(function() {
  ...
  Batman.Model = (function() {
    var functionName, _i, _j, _len, _len2, _ref, _ref2;
    ...
    Model.loadWithOptions = function(options, callback) {
      ...
      return this._doStorageOperation('readAll', options, __bind(function(err, records, env) {
        if (err != null) {
          this.fire('error', err);
          return typeof callback === "function" ? callback(err, []) : void 0;
        } else {
          this.fire('loaded', records, env);
    ...
    Model._mapIdentities = function(records) {
      var existing, id, index, newRecords, record, _len, _ref;
      newRecords = [];
      for (index = 0, _len = records.length; index < _len; index++) {
    ...
    Model.InstanceLifecycleStateMachine = (function() {
      __extends(InstanceLifecycleStateMachine, Batman.DelegatingStateMachine);
    ...
    Model.prototype.fromJSON = function(data) {
      ...
      if (!encoders || encoders.isEmpty() || !encoders.some(function(key, encoder) {
        ...
        encoders.forEach(__bind(function(key, encoder) {
          if (encoder.decode && typeof data[encoder.as] !== 'undefined') {
            return obj[key] = encoder.decode(data[encoder.as], encoder.as, data, obj, this);
          }
        }, this));
      }
      ...
      Batman.developer["do"](__bind(function() {
        if ((!encoders) || encoders.length <= 1) {
          return Batman.developer.warn("Warning: Model " + (Batman.functionName(this.constructor)) + " has suspiciously few decoders!");
        }
      }, this));
    ...
    Model.prototype.loadWithOptions = function(options, callback) {
      ...
      if (this.get('lifecycle').load()) {
        ...
        return this._doStorageOperation('read', options, __bind(function(err, record, env) {
          var callback, _j, _len2;
          if (!err) {
          ...
          for (_j = 0, _len2 = callbackQueue.length; _j < _len2; _j++) {
      ...
      if (this.get('lifecycle').startTransition(startState)) {
        return this.validate(__bind(function(error, errors) {
          ...
          if (error || errors.length) {
            this.get('lifecycle').failedValidation();
            return typeof callback === "function" ? callback(error || errors, this) : void 0;
          }
          associations = this.constructor._batman.get('associations');
          this._withoutDirtyTracking(function() {
            var _ref4;
            return associations != null ? (_ref4 = associations.getByType('belongsTo')) != null ? _ref4.forEach(__bind(function(association, label) {
              return association.apply(this);
            }, this)) : void 0 : void 0;
          });
          return this._doStorageOperation(storageOperation, {
            data: options
          }, __bind(function(err, record, env) {
            if (!err) {
              this.get('dirtyKeys').clear();
              this.get('_dirtiedKeys').clear();
              if (associations) {
                record._withoutDirtyTracking(function() {
                  var _ref4, _ref5;
              ...
              record = this.constructor._mapIdentity(record);
              this.get('lifecycle').startTransition(endState);
            } else {
            ...
            return typeof callback === "function" ? callback(err, record || this, env) : void 0;
          }, this));
        }, this));
      } else {
    ...
    Model.prototype.validate = function(callback) {
      var args, count, errors, finishedValidation, key, validator, validators, _j, _k, _len2, _len3, _ref2;
    ...
    Model.prototype._doStorageOperation = function(operation, options, callback) {
      ...
      return adapter.perform(operation, this, options, __bind(function() {
...
(function() {
  ...
  Batman.Proxy = (function() {
    __extends(Proxy, Batman.Object);
...
(function() {
  ...
  Batman.AssociationProxy = (function() {
    __extends(AssociationProxy, Batman.Proxy);
    ...
    AssociationProxy.prototype.load = function(callback) {
      this.fetch(__bind(function(err, proxiedRecord) {
        if (!err) {
          this._setTarget(proxiedRecord);
        }
...
(function() {
  ...
  Batman.HasOneProxy = (function() {
    ...
    HasOneProxy.prototype.fetchFromRemote = function(callback) {
      ...
      return this.association.getRelatedModel().loadWithOptions(loadOptions, __bind(function(error, loadedRecords) {
        if (error) {
          throw error;
        }
...
(function() {
  ...
  Batman.BelongsToProxy = (function() {
    ...
    BelongsToProxy.prototype.fetchFromRemote = function(callback) {
      ...
      return this.association.getRelatedModel().findWithOptions(this.get('foreignValue'), loadOptions, __bind(function(error, loadedRecord) {
        if (error) {
          throw error;
        }
...
(function() {
  ...
  Batman.PolymorphicBelongsToProxy = (function() {
    ...
    PolymorphicBelongsToProxy.prototype.fetchFromRemote = function(callback) {
      ...
      return this.association.getRelatedModelForType(this.get('foreignTypeValue')).findWithOptions(this.get('foreignValue'), loadOptions, __bind(function(error, loadedRecord) {
        if (error) {
          throw error;
        }
        return callback(void 0, loadedRecord);
...
(function() {
  Batman.URI = (function() {
    ...
    normalizeParams = function(params, name, v) {
      var after, childKey, k, last, matches, _ref, _ref2, _ref3;
  ...
  Batman.SetObserver = (function() {
    ...
    function SetObserver(base) {
      ...
      this._setObservers.set("itemsWereAdded", __bind(function() {
        return this.fire('itemsWereAdded', arguments);
      }, this));
      this._setObservers.set("itemsWereRemoved", __bind(function() {
        return this.fire('itemsWereRemoved', arguments);
      }, this));
...
(function() {
  ...
  Batman.AssociationSet = (function() {
    ...
    AssociationSet.prototype.load = function(callback) {
      ...
      return this.association.getRelatedModel().loadWithOptions(this._getLoadOptions(), __bind(function(err, records) {
        if (!err) {
          this.markAsLoaded();
        }
  ...
  Batman.SetIndex = (function() {
    ...
    function SetIndex(base, key) {
      ...
      if (this.base.isEventEmitter) {
        ...
        this._setObserver.on('itemsWereAdded', __bind(function(items) {
          return this._addItems(items);
        }, this));
        this._setObserver.on('itemsWereRemoved', __bind(function(items) {
          return this._removeItems(items);
        }, this));
      }
    ...
    SetIndex.prototype.observerForItemAndKey = function(item, key) {
      return __bind(function(newKey, oldKey) {
        this._removeItemsFromKey(oldKey, [item]);
        return this._addItemsToKey(newKey, [item]);
      }, this);
    };
    SetIndex.prototype.forEach = function(iterator, ctx) {
      return this._storage.forEach(__bind(function(key, set) {
        if (set.get('length') > 0) {
          return iterator.call(ctx, key, set, this);
        }
      }, this));
    };
    ...
    SetIndex.prototype._addItems = function(items) {
      var index, item, itemsForKey, key, lastKey, _len;
...
(function() {
  ...
  Batman.AssociationSetIndex = (function() {
    ...
    AssociationSetIndex.prototype.forEach = function(iterator, ctx) {
      return this.association.proxies.forEach(__bind(function(record, set) {
        var key;
        key = this.association.indexValueForRecord(record);
        if (set.get('length') > 0) {
          return iterator.call(ctx, key, set, this);
        }
      }, this));
...
(function() {
  ...
  Batman.Navigator = (function() {
    ...
    Navigator.prototype.start = function() {
      ...
      return Batman.setImmediate(__bind(function() {
        if (this.started && Batman.currentApp) {
...
(function() {
  ...
  Batman.RouteMapBuilder = (function() {
    ...
    RouteMapBuilder.prototype.resources = function() {
      var action, actions, arg, args, as, callback, childBuilder, controller, included, k, options, path, resourceName, resourceNames, resourceRoot, routeOptions, routeTemplate, v, _i, _j, _k, _len, _len2, _len3, _ref, _ref2;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
  ...
  Batman.App = (function() {
    ...
    App.run = function() {
      ...
      if (layout) {
        ...
        if (layout !== null) {
          layoutClass = (LayoutView = (function() {
            __extends(LayoutView, Batman.View);
            function LayoutView() {
  ...
  Batman.PluralAssociation = (function() {
    ...
    PluralAssociation.prototype.setForRecord = function(record) {
      ...
      Batman.Property.withoutTracking(__bind(function() {
        return this._setsByRecord.getOrSet(record, __bind(function() {
          var existingValueSet, newSet;
          if (indexValue != null) {
            existingValueSet = this._setsByValue.get(indexValue);
            if (existingValueSet != null) {
              return existingValueSet;
            }
          }
          newSet = this.proxyClassInstanceForKey(indexValue);
          if (indexValue != null) {
            this._setsByValue.set(indexValue, newSet);
          }
          return newSet;
        }, this));
      }, this));
    ...
    PluralAssociation.prototype.setForKey = Batman.Property.wrapTrackingPrevention(function(indexValue) {
      var foundSet;
      foundSet = void 0;
      this._setsByRecord.forEach(__bind(function(record, set) {
        if (foundSet != null) {
          return;
        }
        if (this.indexValueForRecord(record) === indexValue) {
          return foundSet = set;
        }
      }, this));
      if (foundSet != null) {
      ...
      return this._setsByValue.getOrSet(indexValue, __bind(function() {
        return this.proxyClassInstanceForKey(indexValue);
      }, this));
    });
      ...
      if (!baseSaveError) {
        if (relations = this.getFromAttributes(base)) {
          relations.forEach(__bind(function(model) {
            return model.set(this.foreignKey, base.get(this.primaryKey));
          }, this));
        }
...
(function() {
  ...
  Batman.PolymorphicHasManyAssociation = (function() {
    ...
    PolymorphicHasManyAssociation.prototype.apply = function(baseSaveError, base) {
      ...
      if (!baseSaveError) {
        if (relations = this.getFromAttributes(base)) {
          ...
          relations.forEach(__bind(function(model) {
            return model.set(this.foreignTypeKey, this.modelType());
          }, this));
        }
      }
      return true;
    ...
    PolymorphicHasManyAssociation.prototype.decoder = function() {
      ...
      association = this;
      return function(data, key, _, __, parentRecord) {
        var children, id, jsonObject, newChildren, record, recordsToAdd, relatedModel, savedRecord, type, _i, _len;
...
(function() {
  ...
  Batman.RegExpValidator = (function() {
    __extends(RegExpValidator, Batman.Validator);
...
(function() {
  ...
  Batman.InclusionValidator = (function() {
    __extends(InclusionValidator, Batman.Validator);
...
(function() {
  ...
  Batman.ExclusionValidator = (function() {
    __extends(ExclusionValidator, Batman.Validator);
...
(function() {
  ...
  Batman.AssociatedValidator = (function() {
    __extends(AssociatedValidator, Batman.Validator);
    function AssociatedValidator() {
      AssociatedValidator.__super__.constructor.apply(this, arguments);
    }
    ...
    AssociatedValidator.prototype.validateEach = function(errors, record, key, callback) {
      ...
      if (value != null) {
        ...
        count = 1;
        childFinished = __bind(function(err, childErrors) {
          if (childErrors.length > 0) {
            errors.add(key, this.format(key, 'invalid_association'));
          }
          if (--count === 0) {
            return callback();
          }
...
(function() {
  ...
  Batman.ControllerActionFrame = (function() {
    __extends(ControllerActionFrame, Batman.Object);
...
(function() {
  ...
  Batman.HTMLStore = (function() {
    __extends(HTMLStore, Batman.Object);
    function HTMLStore() {
...
(function() {
  ...
  Batman.View = (function() {
    ...
    function View() {
      ...
      this.subviews.on('itemsWereAdded', __bind(function(newSubviews) {
        var subview, _i, _len;
      ...
      this.subviews.on('itemsWereRemoved', __bind(function(oldSubviews) {
        var subview, _i, _len;
    ...
    View.prototype.removeFromParentNode = function() {
      var isInDOM, node, _ref, _ref2;
      node = this.get('node');
      isInDOM = document.body.contains(node);
      if (isInDOM) {
        this.propagateToSubviews('viewWillDisappear');
      }
      if ((_ref = this.node) != null) {
        if ((_ref2 = _ref.parentNode) != null) {
    ...
    View.accessor('node', {
      ...
      set: function(key, node, oldNode) {
        ...
        Batman.developer["do"](__bind(function() {
          var extraInfo, _base;
          extraInfo = this.get('displayName') || this.get('source');
          return typeof (_base = (node === document ? document.body : node)).setAttribute === "function" ? _base.setAttribute('batman-view', this.constructor.name + (extraInfo ? ": " + extraInfo : '')) : void 0;
        }, this));
        return node;
      }
    });
    ...
    View.prototype.initializeBindings = function() {
      ...
      new Batman.Renderer(this.node, this);
    ...
    View.prototype.targetForKeypath = function(keypath) {
      var controller, lookupNode, proxiedObject, _results;
      ...
      while (lookupNode) {
        ...
        if (lookupNode.isView && lookupNode.controller) {
    ...
    View.prototype.setKeypath = function(keypath, value) {
      ...
      target = this.targetForKeypath(prefix);
  ...
  if ((_ref2 = (_base2 = Batman.container).$subviews) == null) {
    _base2.$subviews = function(view) {
      var subviews;
      if (view == null) {
      ...
      view.subviews.forEach(function(subview) {
        ...
        obj.subviews = ((_ref3 = subview.subviews) != null ? _ref3.length : void 0) ? $subviews(subview) : null;
        Batman.unmixin(obj, {
          '_batman': true
        });
...
(function() {
  ...
  Batman.DOM.AbstractBinding = (function() {
    ...
    AbstractBinding.prototype.setupBackingView = function(viewClass, viewOptions) {
      ...
      if ((_ref2 = viewOptions.parentNode) == null) {
  ...
  Batman.BackingView = (function() {
    __extends(BackingView, Batman.View);
    function BackingView() {
      BackingView.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  Batman.DOM.ViewArgumentBinding = (function() {
    ...
    function ViewArgumentBinding(definition, option, targetView) {
      ...
      this.targetView.observe(this.option, this._updateValue = __bind(function(value) {
        if (this.isDataChanging) {
          return;
        }
        return this.view.set(this.keyPath, value);
      }, this));
    }
...
(function() {
  ...
  Batman.DOM.ValueBinding = (function() {
    __extends(ValueBinding, Batman.DOM.AbstractBinding);
...
(function() {
  ...
  Batman.SelectView = (function() {
    __extends(SelectView, Batman.View);
    function SelectView() {
  ...
  Batman.DOM.SelectBinding = (function() {
    ...
    function SelectBinding(definition) {
      ...
      this.childBindingAdded = __bind(this.childBindingAdded, this);      SelectBinding.__super__.constructor.apply(this, arguments);
    ...
    SelectBinding.prototype.childBindingAdded = function(binding) {
      if (binding instanceof Batman.DOM.CheckedBinding) {
        ...
        binding.backingView.on('itemsWereRendered', __bind(function() {
    ...
    SelectBinding.prototype.dataChange = function(newValue) {
      ...
      if (newValue != null ? newValue.forEach : void 0) {
        ...
        newValue.forEach(__bind(function(value) {
          var children, node, _j, _len2;
    ...
    SelectBinding.prototype.fixSelectElementWidth = function() {
      ...
      return this._fixWidthTimeout = setTimeout(__bind(function() {
        this._fixWidthTimeout = null;
        return this._fixSelectElementWidth();
      }, this), 100);
    };
...
(function() {
  ...
  Batman.DeferredRenderView = (function() {
    __extends(DeferredRenderView, Batman.View);
    function DeferredRenderView() {
      DeferredRenderView.__super__.constructor.apply(this, arguments);
    }
    DeferredRenderView.prototype.bindImmediately = false;
    return DeferredRenderView;
  })();
  Batman.DOM.DeferredRenderBinding = (function() {
    __extends(DeferredRenderBinding, Batman.DOM.AbstractBinding);
...
(function() {
  ...
  Batman.developer["do"](function() {
    var DebuggerBinding;
    DebuggerBinding = (function() {
      __extends(DebuggerBinding, Batman.DOM.AbstractBinding);
  ...
  Batman.DOM.EventBinding = (function() {
    ...
    function EventBinding() {
      ...
      callback = __bind(function() {
        var func, target;
        func = this.get('filteredValue');
        target = this.view.targetForKeypath(this.functionPath || this.unfilteredKey);
        if (target && this.functionPath) {
          target = Batman.get(target, this.functionPath);
        }
...
(function() {
  ...
  Batman.DOM.ContextBinding = (function() {
    __extends(ContextBinding, Batman.DOM.AbstractAttributeBinding);
...
(function() {
  ...
  Batman.DOM.FormBinding = (function() {
    __extends(FormBinding, Batman.DOM.ContextBinding);
    ...
    FormBinding.prototype.initializeChildBindings = function() {
      var attribute, binding, errorsNode, field, keyPath, selectedNode, selectedNodes, selectors, _i, _len;
      keyPath = this.keyPath;
      ...
      for (_i = 0, _len = selectedNodes.length; _i < _len; _i++) {
        ...
        selectedNode.setAttribute("data-addclass-" + this.errorClass, "" + attribute + ".errors." + field + ".length");
      }
...
(function() {
  ...
  Batman.DOM.StyleBinding = (function() {
    ...
    StyleBinding.prototype.dataChange = function(value) {
      var colonSplitCSSValues, cssName, key, style, _i, _len, _ref, _ref2;
      if (!value) {
        this.resetStyles();
        return;
      }
    ...
    StyleBinding.prototype.handleArrayChanged = function(array) {
      return this.collection.forEach(__bind(function(key, value) {
        return this.bindSingleAttribute(key, "" + this.keyPath + "." + key);
      }, this));
    };
...
(function() {
  ...
  Batman.DOM.InsertionBinding = (function() {
    __extends(InsertionBinding, Batman.DOM.AbstractBinding);
    ...
    InsertionBinding.prototype.ready = function() {
      return this.bind();
    };
    InsertionBinding.prototype.dataChange = function(value) {
      ...
      if (!!value === !this.invert) {
        ...
        if (!(this.node.parentNode != null)) {
          ...
          Batman.DOM.destroyNode(this.placeholderNode);
        }
        return view != null ? view.fire('viewDidShow') : void 0;
      } else {
        if (view != null) {
...
(function() {
  ...
  Batman.IteratorView = (function() {
    __extends(IteratorView, Batman.View);
    function IteratorView() {
      IteratorView.__super__.constructor.apply(this, arguments);
    }
    ...
    IteratorView.prototype.beginAppendItems = function() {
      return this.fragment = document.createDocumentFragment();
    };
    IteratorView.prototype.appendItem = function(item) {
      var iterationView;
      ...
      return iterationView.parentNode = null;
    };
    IteratorView.prototype.finishAppendItems = function() {
      var node;
      node = this.get('node');
  ...
  Batman.IterationView = (function() {
    __extends(IterationView, Batman.View);
    function IterationView() {
      IterationView.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  Batman.DOM.IteratorBinding = (function() {
    ...
    function IteratorBinding(definition) {
      ...
      this.handleArrayChanged = __bind(this.handleArrayChanged, this);      this.iteratorName = definition.attr;
      ...
      Batman.setImmediate(__bind(function() {
        var parentNode;
        parentNode = this.prototypeNode.parentNode;
        parentNode.insertBefore(this.backingView.get('node'), this.prototypeNode);
        parentNode.removeChild(this.prototypeNode);
        this.bind();
        return this.view.allowAndFire('ready');
      }, this));
    }
    ...
    IteratorBinding.prototype.handleArrayChanged = function(newItems) {
      var subview, _i, _len, _ref;
      _ref = this.backingView.subviews.toArray();
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        subview = _ref[_i];
        subview.die();
      }
    ...
    IteratorBinding.prototype.handleItemsAdded = function(newItems) {
      var item, _i, _len;
      this.backingView.beginAppendItems();
      if (newItems) {
        for (_i = 0, _len = newItems.length; _i < _len; _i++) {
          item = newItems[_i];
          this.backingView.appendItem(item);
        }
      }
      return this.backingView.finishAppendItems();
    };
    IteratorBinding.prototype.handleItemsRemoved = function(oldItems) {
      var subview, _i, _len, _ref;
      _ref = this.backingView.subviews._storage;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        subview = _ref[_i];
...
(function() {
  ...
  Batman.extend(Batman.DOM, {
    ...
    querySelector: (typeof window !== "undefined" && window !== null ? (_ref2 = window.document) != null ? _ref2.querySelector : void 0 : void 0) != null ? function(node, selector) {
    ...
    destroyNode: function(node) {
      ...
      return node != null ? (_ref3 = node.parentNode) != null ? _ref3.removeChild(node) : void 0 : void 0;
    },
    ...
    send: function(data) {
      ...
      request = requestModule.request(options, __bind(function(response) {
        ...
        return response.on('end', __bind(function() {
          ...
          this.set('responseHeaders', response.headers);
          data = data.join('');
