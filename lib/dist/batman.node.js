...
(function() {
  ...
  Batman.RestStorage = (function(_super) {
    ...
    RestStorage.prototype.urlForCollection = function(model, env) {
      var url, _ref;
      url = ((_ref = env.options) != null ? _ref.collectionUrl : void 0) ? url = typeof env.options.collectionUrl === 'function' ? env.options.collectionUrl.call(env.options.urlContext) : env.options.collectionUrl : model.url ? this._execWithOptions(model, 'url', env.options) : this._defaultCollectionUrl(model, env.options);
...
(function() {
  ...
  Batman.AssociationSet = (function(_super) {
    ...
    AssociationSet.prototype._getLoadOptions = function() {
      ...
      if (this.association.options.url) {
        loadOptions.collectionUrl = this.association.options.url;
        console.log(this.association.setIndex(), this.foreignKeyValue);
