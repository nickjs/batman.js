...
(function() {
  ...
  Batman.SetIndex = (function(_super) {
    ...
    function SetIndex(base, key) {
      ...
      if (this.base.isEventEmitter) {
        ...
        this._setObserver.on('itemsWereAdded', function() {
          ...
          items = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
          _this.itemsByKey(items).forEach(_this._addItems.bind(_this));
        });
        this._setObserver.on('itemsWereRemoved', function() {
          var items;

          items = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
          _this.itemsByKey(items).forEach(_this._removeItems.bind(_this));
        });
      }
      this.itemsByKey(this.base).forEach(this._addItems.bind(this));
      this.startObserving();
    }
    ...
    SetIndex.prototype.itemsByKey = function(items) {
      var arr, byKey, item, key, _i, _len,
        _this = this;
    ...
    SetIndex.prototype.observerForItemAndKey = function(item, key) {
      ...
      return function(newKey, oldKey) {
        _this._removeItems(oldKey, [item]);
        return _this._addItems(newKey, [item]);
      };
    };
    ...
    SetIndex.prototype._addItems = function(key, items) {
      var resultSet;
    ...
    SetIndex.prototype._removeItems = function(key, items) {
      var resultSet;
...
(function() {
  ...
  Batman.PolymorphicAssociationSetIndex = (function(_super) {
    ...
    PolymorphicAssociationSetIndex.prototype._addItems = function(key, items) {
      ...
      return PolymorphicAssociationSetIndex.__super__._addItems.call(this, key, filteredItems);
    };

    PolymorphicAssociationSetIndex.prototype._removeItems = function(key, items) {
      var filteredItems, item;
      ...
      return PolymorphicAssociationSetIndex.__super__._removeItems.call(this, key, filteredItems);
    };
...
(function() {
  ...
  Batman.UniqueSetIndex = (function(_super) {
    ...
    UniqueSetIndex.prototype._addItems = function(key, items) {
      UniqueSetIndex.__super__._addItems.apply(this, arguments);
      if (!this._uniqueIndex.hasKey(key)) {
        return this._uniqueIndex.set(key, items[0]);
      }
    };

    UniqueSetIndex.prototype._removeItems = function(key, items) {
      var resultSet;

      resultSet = this._resultSetForKey(key);
      UniqueSetIndex.__super__._removeItems.apply(this, arguments);
