(function() {
  Batman.TestCase = (function() {
    ...
    TestCase.prototype.assertDifference = function(expressions, difference, message, callback) {
      var before, e, error, i, _len, _results;
      if (difference == null) {
        difference = 1;
      }
      ...
      callback();
      _results = [];
      for (i = 0, _len = expressions.length; i < _len; i++) {
        e = expressions[i];
...
(function() {
  ...
  Batman.ModelTestCase = (function() {
    __extends(ModelTestCase, Batman.TestCase);
    function ModelTestCase() {
      ModelTestCase.__super__.constructor.apply(this, arguments);
    }
    ModelTestCase.prototype.assertValid = function(model, message) {
      if (message == null) {
        message = "" + model + " expected to be valid";
      }
      return model.validate(__bind(function(_, err) {
        return this.assert(err.length === 0, message);
      }, this));
    };
