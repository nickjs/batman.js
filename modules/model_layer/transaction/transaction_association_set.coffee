...
module.exports = class TransactionAssociationSet extends Set
  isTransaction: true
  constructor: (associationSet, visited, stack) ->
    ...
    @set('association', associationSet.association)
    @set('foreignKeyValue', associationSet.foreignKeyValue)
  ...
  _addFromAssociationSet: (items, indexes) -> @addArray(items)
  ...
  applyChanges: (visited=[]) ->
    ...
    target.replace(@_originalStorage)
