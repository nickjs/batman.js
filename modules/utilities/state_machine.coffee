...
{BatmanObject, Property, extend} = require 'foundation'

module.exports = class StateMachine extends BatmanObject
  ...
  startTransition: Property.wrapTrackingPrevention (event) ->
    if @isTransitioning
