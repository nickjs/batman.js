...
(function(window) {
  ...
  var QUnit, config, onErrorFnPrev, testId = 0,
  ...
  Test.prototype = {
    ...
    finish: function() {
      ...
      var assertion, a, b, i, li, ol, test = this,
        good = 0,
        bad = 0,
  ...
  QUnit.load = function() {
    ...
    var banner, filter, i, label, len, main, ol, toolbar, userAgent, val, urlConfigCheckboxes, moduleFilter, numModules = 0,
      moduleFilterHtml = "",
      urlConfigHtml = "",
    ...
    var reName = /^function (\w+)/,
      jsDump = {
        ...
        parsers: {
          ...
          node: function(node) {
            var a, val, open = QUnit.jsDump.HTML ? "&lt;" : "<",
